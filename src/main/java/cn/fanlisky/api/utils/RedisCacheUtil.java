...
public class RedisCacheUtil {
    ...
    public String getPre(String prefix, String key) {
        String str = "";
        str = redisTemplate.opsForValue().get(prefix + KEY_SPLIT + key);
        log.info("RedisCacheUtil:get cache key={},value={}", prefix + KEY_SPLIT + key, str);
        return str;
    }
     ...
     */
    public void setPreWithExpireTime(String prefix, String key, String value, long expireTime) {
        redisTemplate.opsForValue().set(prefix + KEY_SPLIT + key, value, expireTime, TimeUnit.SECONDS);
        log.info("RedisCacheUtil:setWithExpireTime cache key={},value={},expireTime={}", prefix + KEY_SPLIT + key, value, expireTime);
    }
    ...
    public long incrPre(String prefix, String key) {
        return redisTemplate.opsForValue().increment(prefix + KEY_SPLIT + key, 1);
    }
    ...
    public void setPre(String prefix, String key, String value) {
        ...
        log.info("RedisCacheUtil:set cache key={},value={}", prefix + KEY_SPLIT + key, value);
    }
